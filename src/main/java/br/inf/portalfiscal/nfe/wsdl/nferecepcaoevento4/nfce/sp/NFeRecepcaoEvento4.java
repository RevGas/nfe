 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://nfce.fazenda.sp.gov.br/ws/NFeRecepcaoEvento4.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.fazenda.sp.gov.br/ws/NFeRecepcaoEvento4.asmx?WSDL");
