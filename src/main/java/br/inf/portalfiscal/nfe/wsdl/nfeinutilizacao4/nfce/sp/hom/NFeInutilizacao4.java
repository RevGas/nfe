 ...
 *
 */
@WebServiceClient(name = "NFeInutilizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", wsdlLocation = "https://homologacao.nfce.fazenda.sp.gov.br/ws/NFeInutilizacao4.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.nfce.fazenda.sp.gov.br/ws/NFeInutilizacao4.asmx?wsdl");
