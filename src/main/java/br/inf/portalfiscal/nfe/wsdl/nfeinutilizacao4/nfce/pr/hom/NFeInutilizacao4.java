 ...
 * 
 */
@WebServiceClient(name = "NFeInutilizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", wsdlLocation = "https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeInutilizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeInutilizacao4?wsdl");
