 ...
 * 
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://homolog.sefaz.go.gov.br/nfe/services/NFeStatusServico4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homolog.sefaz.go.gov.br/nfe/services/NFeStatusServico4?wsdl");
