 ...
 * 
 */
@WebServiceClient(name = "NFeAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4", wsdlLocation = "https://homolog.sefaz.go.gov.br/nfe/services/NFeAutorizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homolog.sefaz.go.gov.br/nfe/services/NFeAutorizacao4?wsdl");
     ...
     * 
     * @return
     *     returns NFeAutorizacao4Service
     */
