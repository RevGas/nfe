 ...
 * 
 */
@WebServiceClient(name = "NFeStatusServico4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeStatusServico4", wsdlLocation = "https://nfe.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfe.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx?WSDL");
