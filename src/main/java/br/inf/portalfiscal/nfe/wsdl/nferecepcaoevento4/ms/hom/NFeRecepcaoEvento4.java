 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://hom.nfe.sefaz.ms.gov.br/ws/NFeRecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://hom.nfe.sefaz.ms.gov.br/ws/NFeRecepcaoEvento4?wsdl");
