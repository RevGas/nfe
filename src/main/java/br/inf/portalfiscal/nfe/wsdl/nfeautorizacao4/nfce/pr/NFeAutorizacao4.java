 ...
 * 
 */
@WebServiceClient(name = "NFeAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4", wsdlLocation = "https://nfce.sefa.pr.gov.br/nfce/NFeAutorizacao4?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.sefa.pr.gov.br/nfce/NFeAutorizacao4?WSDL");
