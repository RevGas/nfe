 ...
 * 
 */
@WebServiceClient(name = "NFeAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4", wsdlLocation = "https://homologacao.nfce.fazenda.sp.gov.br/ws/NFeAutorizacao4.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.nfce.fazenda.sp.gov.br/ws/NFeAutorizacao4.asmx?WSDL");
