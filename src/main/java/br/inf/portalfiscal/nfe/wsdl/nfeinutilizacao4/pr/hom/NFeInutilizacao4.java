 ...
 * 
 */
@WebServiceClient(name = "NFeInutilizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", wsdlLocation = "https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeInutilizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.nfe.sefa.pr.gov.br/nfe/NFeInutilizacao4?wsdl");
