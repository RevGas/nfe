 ...
 *
 */
@WebServiceClient(name = "RecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://homologacao.sefaz.mt.gov.br/nfews/v2/services/RecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.sefaz.mt.gov.br/nfews/v2/services/RecepcaoEvento4?wsdl");
     ...
     */
    @WebEndpoint(name = "RecepcaoEvento4Soap")
    public RecepcaoEvento4SoapCancelamento getRecepcaoEvento4SoapCancelamento() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "RecepcaoEvento4Soap"), RecepcaoEvento4SoapCancelamento.class);
    }
     ...
     */
    @WebEndpoint(name = "RecepcaoEvento4Soap")
    public RecepcaoEvento4SoapCartaCorrecao getRecepcaoEvento4SoapCartaCorrecao() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "RecepcaoEvento4Soap"), RecepcaoEvento4SoapCartaCorrecao.class);
    }
