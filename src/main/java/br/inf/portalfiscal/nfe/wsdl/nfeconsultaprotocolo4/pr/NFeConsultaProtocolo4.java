 ...
 * 
 */
@WebServiceClient(name = "NFeConsultaProtocolo4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://nfe.sefa.pr.gov.br/nfe/NFeConsultaProtocolo4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfe.sefa.pr.gov.br/nfe/NFeConsultaProtocolo4?wsdl");
