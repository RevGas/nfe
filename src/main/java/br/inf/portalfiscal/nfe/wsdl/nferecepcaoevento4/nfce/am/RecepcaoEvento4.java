 ...
 * 
 */
@WebServiceClient(name = "RecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://nfce.sefaz.am.gov.br/nfce-services/services/RecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.sefaz.am.gov.br/nfce-services/services/RecepcaoEvento4?wsdl");
     ...
     */
    @WebEndpoint(name = "RecepcaoEvento4Soap12")
    public RecepcaoEvento4SoapCancelamento getRecepcaoEvento4Soap12Cancelamento() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "RecepcaoEvento4Soap12"), RecepcaoEvento4SoapCancelamento.class);
    }
     ...
     */
    @WebEndpoint(name = "RecepcaoEvento4Soap12")
    public RecepcaoEvento4SoapCartaCorrecao getRecepcaoEvento4Soap12CartaCorrecao() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "RecepcaoEvento4Soap12"), RecepcaoEvento4SoapCartaCorrecao.class);
    }
