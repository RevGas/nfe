 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://hnfce.fazenda.mg.gov.br/nfce/services/NFeRecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://hnfce.fazenda.mg.gov.br/nfce/services/NFeRecepcaoEvento4?wsdl");
