 ...
 * 
 */
@WebServiceClient(name = "NFeConsultaProtocolo4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", wsdlLocation = "https://nfce.sefaz.ms.gov.br/ws/NFeConsultaProtocolo4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfce.sefaz.ms.gov.br/ws/NFeConsultaProtocolo4?wsdl");
