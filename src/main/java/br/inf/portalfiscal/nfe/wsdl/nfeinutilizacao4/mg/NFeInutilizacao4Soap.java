...
@XmlSeeAlso({
    ObjectFactory.class, br.inf.portalfiscal.nfe.TInutNFe.class
})
public interface NFeInutilizacao4Soap {
     ...
     * @param nfeDadosMsg
     * @return
     *     returns br.inf.portalfiscal.nfe.wsdl.nfeinutilizacao4.NFeInutilizacao4Result
     */
    ...
    public NFeInutilizacao4Result nfeInutilizacaoNF(
