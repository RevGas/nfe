 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://nfe.fazenda.mg.gov.br/nfe2/services/NFeRecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfe.fazenda.mg.gov.br/nfe2/services/NFeRecepcaoEvento4?wsdl");
     ...
     */
    @WebEndpoint(name = "NFeRecepcaoEvento4Soap12")
    public NFeRecepcaoEvento4SoapCartaCorrecao getNFeRecepcaoEvento4Soap12CartaCorrecao() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "NFeRecepcaoEvento4Soap12"), NFeRecepcaoEvento4SoapCartaCorrecao.class);
    }
     ...
     */
    @WebEndpoint(name = "NFeRecepcaoEvento4Soap12")
    public NFeRecepcaoEvento4SoapCancelamento getNFeRecepcaoEvento4Soap12Cancelamento() {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "NFeRecepcaoEvento4Soap12"), NFeRecepcaoEvento4SoapCancelamento.class);
    }
     ...
     */
    @WebEndpoint(name = "NFeRecepcaoEvento4Soap12")
    public NFeRecepcaoEvento4SoapCartaCorrecao getNFeRecepcaoEvento4Soap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", "NFeRecepcaoEvento4Soap12"), NFeRecepcaoEvento4SoapCartaCorrecao.class, features);
    }
