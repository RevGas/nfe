 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://homolog.sefaz.go.gov.br/nfe/services/NFeRecepcaoEvento4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homolog.sefaz.go.gov.br/nfe/services/NFeRecepcaoEvento4?wsdl");
