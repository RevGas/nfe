package br.inf.portalfiscal.nfe.wsdl.nferecepcaoevento4;
...
public class SOAPHandlerRecepcaoEventosLog implements SOAPHandler<SOAPMessageContext> {
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        if ((boolean) context.get(MessageContext.MESSAGE_OUTBOUND_PROPERTY)) {
            try {
                ...
                new S3().sendEnvEvento (stringResult.toString());
            } catch (Exception ex) {
                ex.printStackTrace ();
