 ...
 * generated in the br.inf.portalfiscal.nfe.wsdl.nfeautorizacao3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _NfeCabecMsg_QNAME = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeAutorizacao3", "nfeCabecMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.nfe.wsdl.nfeautorizacao3
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NfeAutorizacao3", name = "nfeCabecMsg")
