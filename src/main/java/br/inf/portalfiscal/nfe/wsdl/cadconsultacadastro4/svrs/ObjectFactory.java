 ...
 * generated in the br.inf.portalfiscal.nfe.wsdl.cadconsultacadastro4 package. 
...
public class ObjectFactory {
    ...
    private final static QName _NfeResultMsg_QNAME = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", "nfeResultMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.nfe.wsdl.cadconsultacadastro4
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", name = "nfeResultMsg")
