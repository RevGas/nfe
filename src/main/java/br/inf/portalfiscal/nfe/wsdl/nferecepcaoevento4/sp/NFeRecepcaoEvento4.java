 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://nfe.fazenda.sp.gov.br/ws/nferecepcaoevento4.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfe.fazenda.sp.gov.br/ws/nferecepcaoevento4.asmx?WSDL");
