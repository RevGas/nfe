 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://nfeh.sefaz.ce.gov.br/nfe4/services/NFeRecepcaoEvento4?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfeh.sefaz.ce.gov.br/nfe4/services/NFeRecepcaoEvento4?WSDL");
     ...
     */
    @WebEndpoint(name = "NFeRecepcaoEventoSoap12")
    public NFeRecepcaoEventoSoapCancelamento getNFeRecepcaoEventoSoapCancelamento() {
     ...
     */
    @WebEndpoint(name = "NFeRecepcaoEventoSoap12")
    public NFeRecepcaoEventoSoapCartaCorrecao getNFeRecepcaoEventoSoapCartaCorrecao() {
