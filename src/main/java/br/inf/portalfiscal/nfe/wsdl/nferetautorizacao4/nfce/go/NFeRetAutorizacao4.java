 ...
 * 
 */
@WebServiceClient(name = "NFeRetAutorizacao4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", wsdlLocation = "https://nfe.sefaz.go.gov.br/nfe/services/NFeRetAutorizacao4?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfe.sefaz.go.gov.br/nfe/services/NFeRetAutorizacao4?wsdl");
     ...
     * 
     * @return
     *     returns NFeRetAutorizacao4Service
     */
