...
package br.inf.portalfiscal.nfe.wsdl.nfedistribuicaodfe.an;
...
public interface NFeDistribuicaoDFeSoap {
    ...
    public br.inf.portalfiscal.nfe.wsdl.nfedistribuicaodfe.an.NfeDistDFeInteresseResponse.NfeDistDFeInteresseResult nfeDistDFeInteresse(
        @WebParam(name = "nfeDadosMsg", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeDistribuicaoDFe")
        br.inf.portalfiscal.nfe.wsdl.nfedistribuicaodfe.an.NfeDistDFeInteresse.NfeDadosMsg nfeDadosMsg);
