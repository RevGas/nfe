 ...
 * 
 */
@WebServiceClient(name = "NFeRecepcaoEvento4", targetNamespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", wsdlLocation = "https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeRecepcaoEvento4?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeRecepcaoEvento4?WSDL");
