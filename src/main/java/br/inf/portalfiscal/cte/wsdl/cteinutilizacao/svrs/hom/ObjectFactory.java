 ...
 * generated in the br.inf.portalfiscal.cte.wsdl.cteinutilizacao package. 
...
public class ObjectFactory {
    ...
    private final static QName _CteCabecMsg_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteInutilizacao", "cteCabecMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.cte.wsdl.cteinutilizacao
     * 
     */
