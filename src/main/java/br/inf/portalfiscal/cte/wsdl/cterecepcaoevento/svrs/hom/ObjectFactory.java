package br.inf.portalfiscal.cte.wsdl.cterecepcaoevento.svrs.hom;
 ...
 * generated in the br.inf.portalfiscal.cte.wsdl.cterecepcaoevento package. 
...
public class ObjectFactory {
    ...
    private final static QName _CteCabecMsg_QNAME = new QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento", "cteCabecMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.cte.wsdl.cterecepcaoevento
     * 
     */
