 ...
 * 
 */
@WebServiceClient(name = "CteRecepcaoSinc", targetNamespace = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoSinc", wsdlLocation = "http://homologacao.cte.ms.gov.br/ws/CteRecepcaoSinc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://homologacao.cte.ms.gov.br/ws/CteRecepcaoSinc?wsdl");
