 ...
 * Pode ser chamada por new {@link #TNFeVerificaChave(String)} e depois {@link #isChaveValida()}
 * Ou por NFVerificaChave.{@link #isChaveValida(String)}, verifique a classe de testes NFVerificaChaveTest para mais
 * detalhes .
 */
public class TNFeVerificaChave {

    private final String chave;

    public TNFeVerificaChave(final String chave) {
        this.chave = chave;
    }
    ...
    public static boolean isChaveValida(String chave){
        TNFeVerificaChave nfVerificaChave = new TNFeVerificaChave(chave);
