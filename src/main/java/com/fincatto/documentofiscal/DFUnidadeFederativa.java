...
public enum DFUnidadeFederativa {
    ...
    CE("CE", "Cear\u00E1", "23", null, null, "http://nfce.sefaz.ce.gov.br/pages/consultaNota.jsf", "http://nfceh.sefaz.ce.gov.br/pages/consultaNota.jsf"),
    ...
    ES("ES", "Esp\u00EDrito Santo", "32", "http://homologacao.sefaz.es.gov.br/ConsultaNFCe/qrcode.aspx", "http://app.sefaz.es.gov.br/ConsultaNFCe/qrcode.aspx", "www.sefaz.es.gov.br/nfce/consulta", "http://app.sefaz.es.gov.br/ConsultaNFCe"),
