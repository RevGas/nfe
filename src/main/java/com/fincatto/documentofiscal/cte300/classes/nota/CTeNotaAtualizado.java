...
public class CTeNotaAtualizado extends DFBase {
    ...
    private CTeNotaInfoSupl infoSupl;

    public CTeNotaAtualizado() {
        this.info = null;
        this.signature = null;
        this.infoSupl = null;
    }
    ...
    public CTeNotaInfoSupl getInfoSupl() {
        return infoSupl;
    }

    public void setInfoSupl(CTeNotaInfoSupl infoSupl) {
        this.infoSupl = infoSupl;
    }
}
